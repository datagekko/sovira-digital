    ...
    <main className="pt-10 pb-16 bg-sovira-paper min-h-screen relative">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 max-w-screen-xl relative">
        ...
        <div className="prose prose-lg max-w-none text-sovira-graphite">
          ...
          <h2 className="font-neue-haas font-bold text-2xl text-sovira-black mt-10 mb-4">Information We Collect</h2>
          <ul>
          ...
          <h2 className="font-neue-haas font-bold text-2xl text-sovira-black mt-10 mb-4">How We Use Your Information</h2>
          <ul>
          ...
          <h2 className="font-neue-haas font-bold text-2xl text-sovira-black mt-10 mb-4">Google Analytics</h2>
          <p>
          ...
          <h2 className="font-neue-haas font-bold text-2xl text-sovira-black mt-10 mb-4">Lead Forms & Marketing Emails</h2>
          <p>
          ...
          <h2 className="font-neue-haas font-bold text-2xl text-sovira-black mt-10 mb-4">Cookies</h2>
          <p>
          ...
          <h2 className="font-neue-haas font-bold text-2xl text-sovira-black mt-10 mb-4">Data Security</h2>
          <p>
          ...
          <h2 className="font-neue-haas font-bold text-2xl text-sovira-black mt-10 mb-4">Your Rights</h2>
          <p>
          ...
          <h2 className="font-neue-haas font-bold text-2xl text-sovira-black mt-10 mb-4">Changes to This Policy</h2>
          <p>

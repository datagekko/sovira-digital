    ...
    <main className="pt-10 pb-16 bg-sovira-paper min-h-screen relative">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 max-w-screen-xl relative">
        ...
        <div className="prose prose-lg max-w-none text-sovira-graphite">
          ...
          <h2 className="font-neue-haas font-bold text-2xl md:text-3xl text-sovira-black mt-10 mb-4">Acceptance of Terms</h2>
          <p>
          ...
          <h2 className="font-neue-haas font-bold text-2xl md:text-3xl text-sovira-black mt-10 mb-4">Services</h2>
          <p>
          ...
          <h2 className="font-neue-haas font-bold text-2xl md:text-3xl text-sovira-black mt-10 mb-4">Intellectual Property</h2>
          <p>
          ...
          <h2 className="font-neue-haas font-bold text-2xl md:text-3xl text-sovira-black mt-10 mb-4">90-Day Payback Guarantee</h2>
          <p>
          ...
          <h2 className="font-neue-haas font-bold text-2xl md:text-3xl text-sovira-black mt-10 mb-4">Project Timeline</h2>
          <p>
          ...
          <h2 className="font-neue-haas font-bold text-2xl md:text-3xl text-sovira-black mt-10 mb-4">Limitation of Liability</h2>
          <p>
          ...
          <h2 className="font-neue-haas font-bold text-2xl md:text-3xl text-sovira-black mt-10 mb-4">Governing Law</h2>
          <p>
          ...
          <h2 className="font-neue-haas font-bold text-2xl md:text-3xl text-sovira-black mt-10 mb-4">Changes to Terms</h2>
          <p>
